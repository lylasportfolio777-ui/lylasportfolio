...
export default function BookPage() {
  return (
    <main className="min-h-screen bg-[#F7F7F5] text-[#1C1D20] pt-32 pb-20 px-8 md:px-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-12 mb-20">
          <h1 className="text-5xl md:text-7xl font-light tracking-tight mb-8 uppercase text-[#1C1D20]">
            Project <br/><span className="italic text-[#8C7A5B]">Inquiry</span>
          </h1>
          <p className="text-lg md:text-xl text-[#1C1D20]/60 font-light max-w-2xl leading-relaxed">
